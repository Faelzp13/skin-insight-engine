...
export default function FiltersMinimas() {
      ...
      <div className="flex flex-col md:flex-row gap-4 items-end">
        ...
        <div className="flex-1 w-full">
          ...
          <select
            ...
            className="w-full bg-neutral-50 dark:bg-neutral-950 border border-neutral-300 dark:border-neutral-700 text-neutral-900 dark:text-white rounded-md px-3 py-2 text-sm focus:outline-none focus:border-blue-500"
          >
        ...
        <div className="w-full md:w-auto mt-4 md:mt-0">
          <button
            ...
            className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-md transition-colors"
          >
            Filtrar
          </button>
        </div>
